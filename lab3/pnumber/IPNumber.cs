...
namespace lab5_pnumber.pnumber
{
    public class IPNumber
    {
        ...
        public IPNumber(double a, int b, int c)
        {
            try {
        ...
        public IPNumber(string a, string b, string c) {
        ...
        public IPNumber Copy()
        {
            return this;
        }
        public IPNumber Add(IPNumber d)
        {
        ...
        public IPNumber Substract(IPNumber d)
        {
            IPNumber tmp = new IPNumber(d);
            if (d.b != this.b || d.c != this.c) {
                tmp.n = 0.0;
        ...
        public IPNumber Del(IPNumber d)
        {
            IPNumber tmp = new IPNumber(d);
            if (d.b != this.b || d.c != this.c) {
                tmp.n = 0.0;
